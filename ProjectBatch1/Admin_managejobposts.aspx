<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="Admin_managejobposts.aspx.cs" Inherits="ProjectBatch1.Admin_managejobposts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <Columns>
            ...
            <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="btnapprove" runat="server" Text='<%#Eval("usertype").ToString()=="1" ? "Approved" : "Approve" %>' CommandName="APR" CommandArgument='<%#Eval("jobid") %>' ></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
        </Columns>
