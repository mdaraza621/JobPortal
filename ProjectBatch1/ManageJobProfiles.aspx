<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="ManageJobProfiles.aspx.cs" Inherits="ProjectBatch1.ManageJobProfiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            <td></td>
            <td><asp:GridView ID="gv_jobprofiles" ShowFooter="true" OnRowCommand="gv_jobprofiles_RowCommand" OnRowCancelingEdit="gv_jobprofiles_RowCancelingEdit" DataKeyNames="jpid" runat="server" OnRowUpdating="gv_jobprofiles_RowUpdating" OnRowDeleting="gv_jobprofiles_RowDeleting" OnRowEditing="gv_jobprofiles_RowEditing" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" GridLines="None">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Profile Name">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtname1" runat="server" Text='<%#Eval("jpname") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
